-- Mock Data для автомобилей FastLease
-- Генерация тестовых данных для лизинговой платформы
-- Создано: 2025-10-30
-- Общее количество: 110 автомобилей
...
(
    ...
    'Rock Gray Leather',
    'available',
    '{"batteryRange": "N/A", "drive": "AWD", "fuelEconomy": "26/35 mpg", "performance": ["S line exterior", "Sport suspension"]}'
),
(
    gen_random_uuid(),
    'WAUANAF41NN123458',
