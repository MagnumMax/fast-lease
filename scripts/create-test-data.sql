...
SELECT
  ...
  numbered.client_id,
  numbered.asset_id,
  (ARRAY['NEW', 'OFFER_PREP', 'VEHICLE_CHECK', 'DOCS_COLLECT', 'RISK_REVIEW', 'FINANCE_REVIEW', 'INVESTOR_PENDING', 'CONTRACT_PREP', 'DOC_SIGNING', 'SIGNING_FUNDING', 'VEHICLE_DELIVERY', 'ACTIVE', 'CANCELLED'])[(RANDOM() * 12 + 1)::int],
