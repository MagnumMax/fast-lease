...
export function createDealComponent(data = {}) {
  const {
    ...
    imageUrl = '../../assets/images/rolls-royce-cullinan.jpg',
  ...
  return `
    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <div class="grid gap-6 md:grid-cols-[1fr_320px] md:grid-rows-[auto_1fr] items-stretch">
        ...
        <div class="hidden md:flex md:row-span-2 md:h-full">
          <figure class="h-full w-full overflow-hidden rounded-xl border border-slate-200 shadow-sm">
            <img
              src="${imageUrl}"
              alt="${imageAlt}"
              class="h-full w-full object-cover"
