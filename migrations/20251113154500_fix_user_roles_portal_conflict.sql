-- Align ensure_client_for_contact with portal-aware unique constraint on user_roles.
...
begin
  ...
  insert into public.user_roles (user_id, role, portal, assigned_at)
  values (v_client_id, 'CLIENT', 'client'::public.portal_code, v_now)
  on conflict (user_id, role, portal) do nothing;
