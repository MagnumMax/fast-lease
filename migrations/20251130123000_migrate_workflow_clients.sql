-- Ensure every deal has a client_id mapped from workflow contacts and
-- provide a reusable helper to create/link clients for workflow contacts.
...
set client_id = public.ensure_client_for_contact(d.customer_id)
