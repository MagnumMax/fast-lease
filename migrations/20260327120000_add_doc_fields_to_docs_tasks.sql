        ...
        "task": {
          ...
          "schema": {
            ...
            "fields": [
              ...
              { "id": "doc_company_license", "type": "text", "label": "Лицензия компании (файл)", "hint": "Ссылка/путь к файлу лицензии компании.", "document_type": "company_license" },
              { "id": "doc_emirates_id_manager", "type": "text", "label": "Emirates ID менеджера лицензии (файл)", "hint": "Ссылка/путь к файлу Emirates ID менеджера.", "document_type": "doc_emirates_id_manager" },
              { "id": "doc_passport_manager", "type": "text", "label": "Паспорт менеджера лицензии (файл)", "hint": "Ссылка/путь к файлу паспорта менеджера.", "document_type": "doc_passport_manager" },
              { "id": "doc_emirates_id_driver", "type": "text", "label": "Emirates ID водителя (файл)", "hint": "Ссылка/путь к файлу Emirates ID водителя.", "document_type": "doc_emirates_id_driver" },
              { "id": "doc_passport_driver", "type": "text", "label": "Паспорт водителя (файл)", "hint": "Ссылка/путь к файлу паспорта водителя.", "document_type": "doc_passport_driver" },
              { "id": "doc_driving_license", "type": "text", "label": "Права водителя (для компании)", "hint": "Ссылка/путь к файлу водительских прав.", "document_type": "doc_driving_license" },
              { "id": "doc_passport_buyer", "type": "text", "label": "Паспорт покупателя (файл)", "hint": "Ссылка/путь к файлу паспорта покупателя.", "document_type": "doc_passport_buyer" },
              { "id": "doc_emirates_id_buyer", "type": "text", "label": "Emirates ID покупателя (файл)", "hint": "Ссылка/путь к файлу Emirates ID покупателя.", "document_type": "doc_emirates_id_buyer" },
              { "id": "doc_driving_license_buyer", "type": "text", "label": "Права покупателя (файл)", "hint": "Ссылка/путь к файлу водительских прав покупателя.", "document_type": "doc_driving_license_buyer" },
              { "id": "doc_second_driver_bundle", "type": "text", "label": "Комплект документов второго водителя", "hint": "Ссылка/путь к файлу.", "document_type": "doc_second_driver_bundle" },
              { "id": "doc_vcc_certificate", "type": "text", "label": "VCC (Vehicle Certificate of Conformity)", "hint": "Ссылка/путь к файлу VCC.", "document_type": "vcc_certificate" },
              { "id": "doc_vehicle_possession_certificate", "type": "text", "label": "Vehicle Possession Certificate", "hint": "Ссылка/путь к файлу сертификата.", "document_type": "vehicle_possession_certificate" },
              { "id": "doc_hiyaza_certificate", "type": "text", "label": "Hiyaza", "hint": "Ссылка/путь к файлу.", "document_type": "hiyaza_certificate" },
              { "id": "doc_mulkia_certificate", "type": "text", "label": "Mulkia", "hint": "Ссылка/путь к файлу.", "document_type": "mulkia_certificate" },
              { "id": "doc_passing_certificate", "type": "text", "label": "Passing", "hint": "Ссылка/путь к файлу.", "document_type": "passing_certificate" }
            ]
          },
          "defaults": {
            "buyer_type": "",
        ...
        "task": {
          ...
          "schema": {
            ...
            "fields": [
              ...
              { "id": "doc_company_license", "type": "text", "label": "Лицензия компании (файл)", "hint": "Ссылка/путь к файлу лицензии компании.", "document_type": "company_license" },
              { "id": "doc_quotation", "type": "text", "label": "Quotation (файл)", "hint": "Ссылка/путь к файлу quotation.", "document_type": "quotation" },
              { "id": "doc_tax_invoice", "type": "text", "label": "Tax Invoice (файл)", "hint": "Ссылка/путь к tax invoice.", "document_type": "tax_invoice" },
              { "id": "doc_passing_certificate", "type": "text", "label": "Passing", "hint": "Ссылка/путь к файлу passing.", "document_type": "passing_certificate" },
              { "id": "doc_mulkia_certificate", "type": "text", "label": "Mulkia", "hint": "Ссылка/путь к файлу mulkia.", "document_type": "mulkia_certificate" },
              { "id": "doc_hiyaza_certificate", "type": "text", "label": "Hiyaza", "hint": "Ссылка/путь к файлу hiyaza.", "document_type": "hiyaza_certificate" },
              { "id": "doc_noc_company_letter", "type": "text", "label": "NOC letter (компания)", "hint": "Ссылка/путь к NOC от компании.", "document_type": "noc_company_letter" },
              { "id": "doc_noc_gps_letter", "type": "text", "label": "NOC letter от GPS", "hint": "Ссылка/путь к NOC от GPS (Rent-a-car).", "document_type": "noc_gps_letter" },
              { "id": "doc_trn_certificate", "type": "text", "label": "TRN сертификат", "hint": "Ссылка/путь к TRN сертификату.", "document_type": "trn_certificate" },
              { "id": "doc_vcc_certificate", "type": "text", "label": "VCC (Vehicle Certificate of Conformity)", "hint": "Ссылка/путь к файлу VCC.", "document_type": "vcc_certificate" },
              { "id": "doc_vehicle_possession_certificate", "type": "text", "label": "Vehicle Possession Certificate", "hint": "Ссылка/путь к файлу сертификата.", "document_type": "vehicle_possession_certificate" },
              { "id": "doc_emirates_id_seller", "type": "text", "label": "Emirates ID продавца (файл)", "hint": "Ссылка/путь к файлу Emirates ID продавца.", "document_type": "doc_emirates_id_seller" },
              { "id": "doc_emirates_id_owner", "type": "text", "label": "Emirates ID владельца (файл)", "hint": "Ссылка/путь к файлу Emirates ID владельца.", "document_type": "doc_emirates_id_owner" },
              { "id": "doc_spa_invoice", "type": "text", "label": "SPA invoice", "hint": "Ссылка/путь к файлу SPA invoice.", "document_type": "spa_invoice" }
            ]
          },
          "defaults": {
            "seller_type": "",
        ...
        jsonb_set(payload, '{schema,fields}',
          '{
            "fields": [
              ...
              { "id": "doc_driving_license", "type": "text", "label": "Права покупателя/водителя (файл)", "hint": "Ссылка/путь к файлу водительских прав." },
