...
SELECT
    ...
    END,
    'Подробное описание и инструкции по данной теме. Содержит всю необходимую информацию для решения типичных вопросов покупателей.',
...
-- =====================================================================
-- 5.2 ОБРАТНАЯ СВЯЗЬ ПОКУПАТЕЛЕЙ (40 записей)
-- =====================================================================
