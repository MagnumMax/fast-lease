...
- **Сделки (`ops/deals/index.html`):**
  ...
  - (M) Выпадающие справочники «Клиент» и «Автомобиль» в модалке создания сделки ограничиваются по высоте (≥320px) и поддерживают прокрутку для длинных списков, чтобы не перекрывать диалог.
