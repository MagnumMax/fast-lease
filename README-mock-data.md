...
- **Специалисты поддержки** (4): Техническая поддержка, покупательский сервис
...
- **Покупатели** (10): Частные лица и бизнес
...
- **Тикеты поддержки**: Покупательский сервис
...
| Покупатель | `ahmedal-zahra@fastlease.ae` | `123456` |
...
├── mock-clients.sql              # Покупатели и профили
...
### Ошибка зависимостей
Загружайте файлы в правильном порядке (пользователи → автомобили → покупатели → сделки).
