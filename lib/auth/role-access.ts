...
const ACCESS_SECTION_DEFINITIONS = [
  // Client portal
  {
    id: "client_dashboard",
    label: "Dashboard",
    description: "Основной обзор клиента.",
  ...
  },
  {
    id: "client_invoices",
    label: "Invoices",
    description: "Счета и платежи клиента.",
  ...
  },
  {
    id: "client_documents",
    label: "Documents",
    description: "Документы и файлы клиента.",
  ...
  },
  {
    id: "client_profile",
    label: "Profile",
    description: "Профиль и настройки клиента.",
  ...
  },
  {
    id: "client_referrals",
    label: "Referrals",
    description: "Реферальные программы клиента.",
  ...
  },
  {
    id: "client_support",
    label: "Support",
    description: "Поддержка клиента и обращения.",
  ...
  },
  {
    id: "client_all",
    label: "Other",
    description: "Прочие страницы клиентского кабинета.",
    prefix: "/client",
    defaultRoles: ["CLIENT"],
  },
  ...
  },
  {
    ...
    label: "Clients",
    description: "Каталог клиентов для всех ролей.",
