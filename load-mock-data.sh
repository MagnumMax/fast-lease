...
echo "👥 Загружаем данные покупателей..."
echo "➡️ Выполни через MCP: mock-clients.sql"

echo "✅ Покупатели — выполнено вручную через MCP"
...
echo "   Администратор: admin@fastlease.ae / 123456"
echo "   Операционный менеджер: opmanager@fastlease.ae / 123456"
echo "   Покупатель: ahmedal-zahra@fastlease.ae / 123456"
echo ""
